...
namespace IntermediarioMuitosParaMuitosFluentAPI.Controllers
{
    public class EmpregadoTrabalhosController : Controller
    {
        private readonly ApplicationDbContext _context;

        public EmpregadoTrabalhosController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            var applicationDbContext = _context.EmpregadosTrabalhos.Include(e => e.Empregado).Include(e => e.Trabalho);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var empregadoTrabalho = await _context.EmpregadosTrabalhos
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var empregadoTrabalho = await _context.EmpregadosTrabalhos.FindAsync(id);
            if (empregadoTrabalho == null)
            {
                return NotFound();
            }
        ...
        {
            var empregadoTrabalho = await _context.EmpregadosTrabalhos.FindAsync(id);
            _context.EmpregadosTrabalhos.Remove(empregadoTrabalho);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.EmpregadosTrabalhos.Any(e => e.EmpregadoId == id);
        }
    }
}
