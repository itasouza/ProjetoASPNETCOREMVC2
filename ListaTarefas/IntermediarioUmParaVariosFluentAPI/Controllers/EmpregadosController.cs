...
namespace IntermediarioUmParaVariosFluentAPI.Controllers
{
    public class EmpregadosController : Controller
    {
        private readonly ApplicationDbContext _context;

        public EmpregadosController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            var applicationDbContext = _context.Empregados.Include(e => e.Trabalho);
