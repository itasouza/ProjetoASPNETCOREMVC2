...
namespace ProjetoAlbumFotos.Controllers
{
    public class AlbunsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AlbumId,Destino,FotoTopo,DataInicio,DataFim")] Album album, IFormFile arquivo)
        {
