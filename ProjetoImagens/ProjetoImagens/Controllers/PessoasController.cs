...
namespace ProjetoImagens.Controllers
{
    public class PessoasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PessoaId,Nome,Foto")] Pessoa pessoa, IFormFile vImagem)
        {
            if (ModelState.IsValid)
            {
                if (vImagem != null)
                {
                    ...
                    using (var or = vImagem.OpenReadStream())
                    {
